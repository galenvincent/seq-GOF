...
# Read files output from experiments
read_sims_stride <- function (N = '500', Q = '200', L = '16', ntrain = '300', mtrain = '1', 
                       neval = '300', meval = '1', alpha = '0.6', delta = '0.6', stride = '1',
                       root = 'data/') {
  
  base = paste0('reps_',N, '-Q_',Q, '-L_',L, '-stride_',stride, 
